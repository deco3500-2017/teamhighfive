...
**Yaxin Cui** - In the past weeks, my main duty is user testing and interview. I have done some face to face user interview (with record by permission)and I have also done some research in order to compare the exit application to our concept. But we want to finish the survey first and then user testing will focus more on this. And I have also help for designed the [questionnaire](https://goo.gl/forms/VHBIwYqgkEk421xG3
)
