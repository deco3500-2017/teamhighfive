...
Yaxin Cui | I have done the user interview, all are our potential target audience. And here are the thing is useful. Verify each step, like register with really IC, verify the certificate. Build a like button show how many people interested in this startup.  Then, the user can use more service if they have higher credit about trustworthiness. Add comment section for each startup post. Next, it can have one more feedback section but this one is optional. All the interview detail and summary can be found in [there](https://github.com/deco3500-2017/teamhighfive/blob/master/Week%2012%20stand%20up/user%20interview_WEEK12.pdf) And I have done the Observation User Testing  (https://github.com/deco3500-2017/teamhighfive/blob/master/Week%2012%20stand%20up/Prototype%20Observation%20Task_Testing.pdf)There are 5 tasks for the tester to complete and I write down the observation result in this doc, noted down if there are any usability problem for our product.Then, I also require the tester to complete the survey. 
